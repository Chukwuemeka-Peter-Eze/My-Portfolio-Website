...
export default function CertificationJourneyCard({
  ...
  return (
    <article className="rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-lg transition duration-300 hover:-translate-y-1 hover:border-cyan-400">
      ...
      {/* Footer */}
      <div className="mt-10 grid gap-6 border-t border-slate-700 pt-6 md:grid-cols-2">
