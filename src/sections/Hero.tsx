          ...
          <FadeUp>
            <div>
              <div className="flex flex-wrap items-center gap-3">
                <Badge>Open to Remote • Global • Relocation</Badge>
                <span className="inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-50 px-4 py-2 text-sm font-medium text-amber-700 dark:bg-amber-500/10 dark:text-amber-400">
                  <span className="relative flex h-2 w-2">
                    <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-amber-400 opacity-75" />
                    <span className="relative inline-flex h-2 w-2 rounded-full bg-amber-500" />
                  </span>
                  Currently: {profile.currentLearning}
                </span>
              </div>
